...
property and value pairs (second argument). Each property and value pair of the source object has to be present 
in the object from the collection if it is to be included 
...
contains the property and its value, that was passed on as the second argument. */
